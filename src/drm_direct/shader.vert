...
void main() {
  vec3 input_position = vec3(
    vertex_buffer.data[ gl_VertexIndex * 6u + 0u ],
    vertex_buffer.data[ gl_VertexIndex * 6u + 1u ],
    vertex_buffer.data[ gl_VertexIndex * 6u + 2u ]
  );
  vec3 input_normal = vec3(
    vertex_buffer.data[ gl_VertexIndex * 6u + 3u ],
    vertex_buffer.data[ gl_VertexIndex * 6u + 4u ],
    vertex_buffer.data[ gl_VertexIndex * 6u + 5u ]
  );
